...
//		p.parse();
		...
		String lastBlockHash = BCProperties.getProperty("last.block", "0000000000000000061338c784fa43a7fce7d3fe671e4d79e06fb8de704da30f") ;
		String lastTranHash = BCProperties.getProperty("last.trans", "20c8598e3597bd51d325b4f69d3673fc336ebb838fd77fe9050179f2cd27fda1") ;
		String currTranHash = BCProperties.getProperty("curr.trans", "11474b5c73ed018bb09cc8647e12212eec1e0bd32b45fa444dfc479b68c2cc0f") ;
		String lastAddr = BCProperties.getProperty("last.addr", "12hLCoGF2bRr7TmFeS3Pr5zASYqfRXoKgj") ;
